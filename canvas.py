...
class OurCanvas(Canvas):
    ...
    def onMouseDown(self, sender, x, y):
        images = ['instructions%20screen.png', 'titlecard.png', 'scene 1.png', 'scene 1 click.png',
        'scene 2 .png', 'scene 2 cl1.png', 'scene 2 cl2.png', 'scene 3.png',
        'scene 3.png', 'scene 3 cl.png', 'end.png' ]
